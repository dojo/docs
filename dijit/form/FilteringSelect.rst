...
`note:` FilteringSelect differs from a `ComboBox <dijit/form/ComboBox>`_ in that the displayed value and hidden value are always the same. the value of the OPTION tag is ignored. 
