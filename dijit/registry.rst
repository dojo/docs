...
The dijit.regsitry is a collection of all Dijit widgets within a page. It can be used for bulk operation and control of groups of widgets. The registry is an instance of a `Dijit WidgetSet <dijit/WidgetSet>`_ and is present on all pages using Dijits.
