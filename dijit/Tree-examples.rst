...
(the section that was here has been removed, as I realised it was documenting code on trunk.  1.4 should contain a ``Tree.attr('path', ...)`` approach which will expand and select nodes for us.)
