...
Coming with this, the recommended way to set properties changes from

.. code-block :: javascript

   this.attr('value', node.property); // old way and now deprecated

to

.. code-block :: javascript

   this.set('value', node.property); // new since 1.5

The same for getting properties:

.. code-block :: javascript

   this.attr("value", newValue); // old way and now deprecated

changes to

.. code-block :: javascript

   this.set("value", newValue); // new since 1.5
