...
* New 'Map Chart' widget ( dojox.charting.Map ) provides an easy way to display geographical (Shapefile) map data.  ( eg: USA by state etc... )  `#10647 <http://bugs.dojotoolkit.org/ticket/10647>`_
