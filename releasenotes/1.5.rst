...
Claro theme
-----------
A new theme for dijit has been released for dijit and the grid called Claro (nee Lucid).  The Claro theme has several main aims:
   ...
   - It delivers the 'fit and finish' professional quality with consistent padding, font treatment and alignment; and fixed missing expected hover, active and selected behavioral states in widgets.
...
For more details on Themes (including Claro) and theming, see `http://docs.dojocampus.org/dijit-themes`_.
