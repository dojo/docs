...
The Claro theme supports both left-to-right (LTR) and right-to-left (RTL) display, and all the browsers, albeit with graceful degradation of some styling: no 24 bit PNG's in IE6; and no rounded corners in IE6,7 and 8.
