...
See `Themes and Theming <dijit-themes>`_ for more information on Dijit themes (Claro, Tundra, Nihilo and Soria)
...
Added new module: `dojox.lang.async <dojox/lang/async>`_. It helps to arrange the order of asynchronous operations (the ones that return dojo.Deferred). Following arrangements are supported:
