...
* Brand new charting themes based on new facilities:
  ...
  * ThreeD -- extends PrimaryColors by adding 3D cylinder look to all bar- and column-based plots.
...
CSS3
----
New dojo.style extension to support for the transform and transform-origin properties:
