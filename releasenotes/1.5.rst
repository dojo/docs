...
ColorPalette
------------
Now supports attr("value", ...) and indicates the currently selected color via a thin black border.   The editor's foreground and background color plugins also indicate the color of the currently selected text (or if no text is selected, the text around the caret).
