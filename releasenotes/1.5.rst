...
The Claro theme supports both LTR and RTL and all the browsers, including IE6, albeit with graceful degradation of some styling (no gradient shading and 8-bit colored icons); and graceful degradation in IE6,7,8 with square corners.
