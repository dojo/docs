...
この文書は http://docs.dojocampus.org/releasenotes/1.5 の翻訳版です。もし翻訳にエラーがあったり、オリジナルの文書が更新されている場合は、英語で書かれたオリジナル文書の最新版を信頼してください。
...
Dijitテーマ(Claro, Tundra, Nihilo, Soria)に関する詳細情報および更新情報は `Themes and Theming <http://docs.dojocampus.org/dijit-themes>`_ (英語)を参照してください。
