...
----------------------------------
* New :ref:`ConfirmDialog <dijit/ConfirmDialog>` class that extends :ref:`dijit/Dialog <dijit/Dialog>`
  by automatically adding OK and Cancel buttons.
* New :ref:`ConfirmTooltipDialog <dijit/ConfirmTooltipDialog>` class that extends
