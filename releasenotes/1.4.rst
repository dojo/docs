...
* `dojox.editor.plugins.NormalizeIndentOutdent <dojox/editor/plugins/NormalizeIndentOutdent>`_:  A plugin that tries to normalize indent and outdent behavior across browsers.  
