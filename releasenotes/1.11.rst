...
Added feature tests for Edge, 'has("edge")', and modern Opera, 'has("opr")'. That said, usage of this is strongly discourated. Whenever possible, you should not use sniffing and should instead use feature detection.
