...
- ``packageMap`` was *deprecated* in lieu of the proposed AMD standard ``map`` configuration; see `AMD map <http://https://github.com/amdjs/amdjs-api/wiki/Common-Config>`_

- module-level configuration as per the proposed `AMD standard <http://https://github.com/amdjs/amdjs-api/wiki/Common-Config>`_
