...
See :ref:`Calendar reference guide <dojox/calendar>`. 

CometD
------

The CometD library has been removed from DojoX. The CometD project now maintains its own Dojo library in AMD format
as part of their project. This will be available via cpm, or may be downloaded from GitHub.
...
See :ref:`Gauge Framework Reference Guide <dojox/dgauges>`.

Lightstreamer
-------------

The LightstreamerStore has been removed from DojoX. The Lightstreamer project now maintains its own Dojo library in
AMD format as part of their project. This will be available via cpm, or may be downloaded from GitHub.
...
See :ref:`Treemap Reference Guide <dojox/treemap>`.
...
Dojox.app framework now gives a clearer MVC structure by providing application controllers (dojox/app/Controller), 
view objects (dojox/app/View) and integration with data model/binding (dojox/mvc).
...
* dojox/app/bind has been removed, use dojox/mvc controllers which give the developer more fexibility.
* dojox/app/Controller has been added to add more fexibility in controlling the application, several controllers are provided in dojox/app/controllers package: Load controller, Transition controller, Layout controller and History controller
...
- parserAutoRequire: a demonstration application for the auto-requirement and declarative requirement features of 
  dojo/parser.
