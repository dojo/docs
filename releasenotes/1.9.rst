...
*Features*
   ...
   * Dojo Mobile sets the ``dojoClick`` property on the document body, so click events are fired immediately
     on touch end events for all Mobile widgets. See the dojo/touch section in Dojo Core above.
