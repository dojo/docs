...
Please refer to `dojo/touch <dojo/touch>`_ doc(TODO) for more details.
...
Also please refer to `dojo/gesture <dojo/gesture>`_ doc(TODO) for how to write a new gesture instance
