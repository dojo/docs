...
ToolBarButton is a button that is placed in the Heading widget. It is a subclass of dojox.mobile.AbstractItem just like ListItem or IconItem. So, unlike Button, it has basically the same capability as ListItem or IconItem, such as icon support, transition, etc.
