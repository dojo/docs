...
.. cv-compound::
  ...
  .. cv:: html
    ...
    <div id="chatroom"> 
    	<div><label for="sendName" style="float: left; width: 100px;">Name:</label> <input id="sendName" type="text" dojoType="dijit.form.TextBox"></div>
    	<div><label for="sendText" style="float: left; width: 100px;">Message:</label> <input id="sendText" type="text" dojoType="dijit.form.TextBox"><button id="send" dojoType="dijit.form.Button">Send Message</button></div>
