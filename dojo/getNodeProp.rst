...
Dojo 1.7 (AMD)
--------------
In dojo 1.7, dojo.getNodeProp has been kept in dojo/_base/html as a compatibility of dojo version before, it is a alias of attr.getNodeProp in dojo/dom-attr.
