...
.. csv-table:: 
 ...
 :ref:`dojo/sniff <dojo/sniff>`, opr, "Environment is running on the Opera browser platform version 15+ (Dojo 1.10.5+)"
 ...
 :ref:`dojo/sniff <dojo/sniff>`, edge, "Environment is running on the Edge browser platform version 12+ (Dojo 1.10.5+)"
