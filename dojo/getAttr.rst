...
Since 1.7 it is an alias of attr.get in dojo/dom-attr.
...
Dojo 1.7 (AMD)
--------------
In dojo 1.7, dojo.getAttr has been kept in dojo/_base/html as a compatibility of dojo version before, it is an alias of attr.get in dojo/dom-attr.
