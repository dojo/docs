...
.. cv-compound::
  ...
  .. cv :: html
    ...
    <button id="refButton1" data-dojo-type="dijit.form.Button" data-dojo-params="onClick:testIndxOf" type="button">Show the index of the word 'zoo' within the array.</button>
    <div id="result1"></div>
