...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div dojoType="dijit.form.Button" data-dojo-id="button">Click to find the spices!</div>
    <br>
    <br>
    <span id="list">
    </span>
...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div dojoType="dijit.form.Button" data-dojo-id="button2">Click to find the items in an aisle starting with C!</div>
    <br>
    <br>
    <span id="list2">
    </span>
