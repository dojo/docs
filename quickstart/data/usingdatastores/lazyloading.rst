...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div dojoType="dijit.tree.ForestStoreModel" jsId="geographyModel" store="geographyStore" query="{}" rootId="Geography" rootLabel="Geography" initialQuery="{type: 'contintent'"></div>
